...
int light = 1, day = 1, plane = 0, comet = 0, xm = 900, bus = 0, buses = 0;
char ch;
...
void draw_object()
{
	...
	if (bus == 1)
	{
		if (buses == 1) {
			...
			glColor3f(1.0, 1.0, 1.0);
			glBegin(GL_POLYGON);
			glVertex2f(-805 + i - xm, 165);
			glVertex2f(-805 + i - xm, 255);
			glVertex2f(-965 + i - xm, 255);
			glVertex2f(-965 + i - xm, 165);
			glEnd();
			...
			glColor3f(1.0, 1.0, 1.0);
			glBegin(GL_POLYGON);
			glVertex2f(55 + i - xm, 165);
			glVertex2f(55 + i - xm, 255);
			glVertex2f(-65 + i - xm, 255);
			glVertex2f(-65 + i - xm, 165);
			glEnd();
...
int main(int argc, char** argv)
{
	int c_menu;
	printf("--------------------------------------------------------------------------------\n");
	printf("                    ARRIVAL AND DEPARTURE OF BUS                              \n");
	printf("--------------------------------------------------------------------------------\n");
	...
	printf("Press 'b' or 'B' Bus arrive at station.\n\n");
	...
	glutAddMenuEntry("1 Bus", 1);
	glutAddMenuEntry("2 Bus", 2);
	glutAddMenuEntry("3 Bus", 3);
	c_menu = glutCreateMenu(main_menu);
	glutAddMenuEntry("Aeroplane", 1);
	glutAddMenuEntry("Comet", 2);
	glutAddSubMenu("Bus", subMenu);
